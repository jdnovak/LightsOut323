...
public class OpenLoopDrive extends Command {
  ...
  public void execute() {
    ...
    Robot.drivetrain.driveVelocity(oi.driverController.getRawAxis(0), oi.driverController.getRawAxis(1), oi.driverController.getRawAxis(4) ,ControlMode.PercentOutput);
  }
