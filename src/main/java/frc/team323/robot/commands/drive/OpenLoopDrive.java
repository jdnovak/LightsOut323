...
public class OpenLoopDrive extends Command {
  ...
  public void execute() {
    ...
    Robot.drivetrain.driveVelocity(Robot.oi.driverController.getRawAxis(0) * -1, Robot.oi.driverController.getRawAxis(1)* 1, Robot.oi.thetaController.getRawAxis(0) * -1 ,ControlMode.PercentOutput);
  }
