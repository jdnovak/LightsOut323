...
public class Robot extends TimedRobot {
  ...
  public void updateSmartDashboard() {
    for (int i = 0; i < 4 ; i++ ) {
      SmartDashboard.putNumber("Wheel_"+i+"_Angle", Robot.drivetrain.getWheel(i).getAngle());
      SmartDashboard.putNumber("Wheel_"+i+"_Encoder", Robot.drivetrain.getWheel(i).getDriveEncoder());
    }
